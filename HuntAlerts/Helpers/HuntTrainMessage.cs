...
public class HuntTrainMessage
{
    ...
    public HuntTrainMessage(string message, string huntType, string huntKind, string huntWorld, string currentworldName, string currentregionName, string huntregionName, string posted_Time, string startLocation, string startZone, int instance, string locationCoords, bool openmaponArrival, bool teleporterEnabled, bool lifestreamEnabled) //autogenerated
    {
